...
## Installation
1. Clone the repository: git clone git@github.com:smalorni/mindful-journey-client.git
...
4. Run npm start and should see http://localhost:3000/login in browser